/*!
 * vue-observer.js v0.0.1
 * From Vue.js (c) 2014-2017 Evan You
...
function initProps (vm) {
  ...
  if (props) {
    ...
    for (var i = 0; i < keys.length; i++) {
      var key = keys[i];
      defineReactive$$1(vm, key, props[key]);
    }
  }
}
...
function VueModel$1 (options) {
  this._init(options);
}

initMixin(VueModel$1);
stateMixin(VueModel$1);
renderMixin(VueModel$1);
